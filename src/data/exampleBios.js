export const EXAMPLE_BIOS = {
  ...
  'Sherlock Holmes':
    "Détective légendaire capable de transformer une observation infime en argument imparable. Il ne dit jamais ce qu'il ne peut pas prouver.",
  'Tyrion Lannister':
    "Le stratège des mots dans Game of Thrones. Il retourne chaque situation avec une précision rhétorique implacable et sait exactement quand tirer à balles réelles.",
  'Sixtine Moullé-Berteaux':
    "Experte en personal branding LinkedIn, elle partage son savoir avec une générosité rare et construit une communauté autour de la croissance professionnelle authentique.",
  'Matthias Baccino':
    "Entrepreneur et pédagogue, il démocratise les stratégies business pour les créateurs de contenu avec des guides clairs, structurés et immédiatement actionnables.",
  'Dumbledore':
  ...
  'Jules Stimpfling':
    "Expert en stratégie de contenu, il partage ses explorations et hypothèses avec une honnêteté intellectuelle qui nourrit le débat et inspire la réflexion.",
  'Hermione Granger':
    "La chercheuse par excellence : elle ne dit rien sans avoir vérifié les sources et explore chaque sujet jusqu'au bout, même quand ça dérange.",
  'Dr. Alan Grant':
    "Paléontologue de terrain qui préfère le doute méthodique aux certitudes confortables. Ses découvertes remettent toujours les idées reçues en question.",

  // ── Grande Gueule ───────────────────────────────────────────────────────────
  'Victor Ferry':
    "Docteur en rhétorique et créateur YouTube, il déconstruit les faux raisonnements et biais cognitifs avec une rigueur analytique que peu osent contredire.",
  'Laurent Alexandre':
  ...
  'Anthony Bourbon':
    "Entrepreneur et dirigeant charismatique, il galvanise son audience autour de ses convictions sur l'entrepreneuriat avec un franc-parler et une énergie rares.",
  'Carlos Diaz':
    "Leader d'opinion sur LinkedIn, il embarque ses abonnés dans ses causes avec une énergie et une authenticité qui suscitent l'adhésion et le passage à l'action.",
  'Daenerys Targaryen':
    "La Mère des Dragons transforme sa propre cause en mouvement collectif irrésistible. Son élan mobilise des armées entières autour de ses convictions.",
  'Jordan Belfort':
    "Le Loup de Wall Street incarne le tribun à l'état pur : capable de faire croire en n'importe quoi par la seule force de ses mots et de son énergie.",
  'Le Motif':
    "Collectif qui remet en cause les codes du monde professionnel avec des questions qui dérangent et des analyses à contre-courant des discours dominants.",
  'Grégoire Gambatto':
  ...
  // ── Leader ──────────────────────────────────────────────────────────────────
  'Théo Fernandez':
    "Expert en personal branding et stratégie LinkedIn, il structure des méthodologies claires et accessibles pour aider les professionnels à trouver leur voix.",
  'Mélody Madar':
  ...
  'Hasheur':
    "Pionnier de la crypto-éducation en France, il construit une communauté curieuse et engagée autour des nouvelles technologies avec un sens pédagogique rare.",
  'Blaise Matuidi':
  ...
  // ── Explorateur ─────────────────────────────────────────────────────────────
  'Guillaume Moubeche':
    "Co-fondateur de lemlist, il explore et documente les frontières de la cold outreach et de la sales automation avant tout le monde, avec une rigueur décomplexée.",
  'Romain Lanery':
    "Créateur de contenu qui explore les tendances émergentes du marketing et partage ses découvertes avant qu'elles deviennent du bruit ambiant pour tout le monde.",
  'Harry Potter':
  ...
  'Toinon Georget':
    "Fondatrice qui remet en cause les normes du monde professionnel avec courage et une exploration sincère des chemins non balisés et des vérités inconfortables.",
  'Indiana Jones':
